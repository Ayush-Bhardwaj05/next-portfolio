...
function Footer() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/Ayush-Bhardwaj05")
  ...
  return (
    <footer>
      <Link
        href="https://github.com/Ayush-Bhardwaj05"
        target="_blank"
        className="footer-link"
      >
        <span className="footer-info">Designed and Built by Ayush Bhardwaj.</span>
        {githubInfo && (
